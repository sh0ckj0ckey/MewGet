...
internal sealed class SegoeFluentIconsGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateSource((string Name, string Code)[] icons)
    {
        ...
        sb.AppendLine("    /// Gets all available icons in the Segoe Fluent Icons font.");
        sb.AppendLine("    /// </summary>");
        sb.AppendLine("    /// <returns>A cached read-only list containing all available icons.</returns>");
        sb.AppendLine("    public static IReadOnlyList<IconInfo> GetAllIcons()");
        sb.AppendLine("    {");
        sb.AppendLine("        return _allIcons ??= new IconInfo[]");
        sb.AppendLine("        {");
